...
import static org.luminedroid.util.DeviceKeysConstants.*;
...
public class ButtonSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final int torchLongPressPowerTimeout = Settings.System.getInt(resolver,
                LumineSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT, 0);
        ...
        Action backLongPressAction = Action.fromSettings(resolver,
                LumineSettings.System.KEY_BACK_LONG_PRESS_ACTION,
                defaultBackLongPressAction);
        Action homeLongPressAction = Action.fromSettings(resolver,
                LumineSettings.System.KEY_HOME_LONG_PRESS_ACTION,
                defaultHomeLongPressAction);
        Action homeDoubleTapAction = Action.fromSettings(resolver,
                LumineSettings.System.KEY_HOME_DOUBLE_TAP_ACTION,
                defaultHomeDoubleTapAction);
        Action appSwitchLongPressAction = Action.fromSettings(resolver,
                LumineSettings.System.KEY_APP_SWITCH_LONG_PRESS_ACTION,
                defaultAppSwitchLongPressAction);
        Action edgeLongSwipeAction = Action.fromSettings(resolver,
                LumineSettings.System.KEY_EDGE_LONG_SWIPE_ACTION,
                Action.NOTHING);
        ...
        if (hasAssistKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    LumineSettings.System.KEY_ASSIST_ACTION, Action.SEARCH);
            mAssistPressAction = initList(KEY_ASSIST_PRESS, pressAction);

            Action longPressAction = Action.fromSettings(resolver,
                    LumineSettings.System.KEY_ASSIST_LONG_PRESS_ACTION, Action.VOICE_SEARCH);
        ...
        if (hasAppSwitchKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    LumineSettings.System.KEY_APP_SWITCH_ACTION, Action.APP_SWITCH);
        ...
        if (hasVolumeKeys) {
            ...
            int swapVolumeKeys = Settings.System.getInt(resolver,
                    LumineSettings.System.SWAP_VOLUME_KEYS_ON_ROTATION, 0);
            ...
            final boolean volumePanelOnLeft = Settings.Secure.getIntForUser(resolver,
                    LumineSettings.Secure.VOLUME_PANEL_ON_LEFT, 0, UserHandle.USER_CURRENT) != 0;
        ...
        if (mEnableTaskbar != null) {
            if (!hasNavigationBar()) {
                ...
                mEnableTaskbar.setChecked(Settings.System.getInt(resolver,
                        LumineSettings.System.ENABLE_TASKBAR,
    ...
    public void onResume() {
        ...
        if (mHomeAnswerCall != null) {
            final int incallHomeBehavior = Settings.Secure.getInt(getContentResolver(),
                    LumineSettings.Secure.RING_HOME_BUTTON_BEHAVIOR,
                    LumineSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DEFAULT);
            final boolean homeButtonAnswersCall =
                (incallHomeBehavior == LumineSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mBackLongPressAction ||
            ...
            handleListChange(mMenuPressAction, newValue,
                    LumineSettings.System.KEY_MENU_ACTION);
            return true;
            ...
            handleListChange(mAssistPressAction, newValue,
                    LumineSettings.System.KEY_ASSIST_ACTION);
            return true;
        } else if (preference == mAssistLongPressAction) {
            handleListChange(mAssistLongPressAction, newValue,
                    LumineSettings.System.KEY_ASSIST_LONG_PRESS_ACTION);
            return true;
        } else if (preference == mAppSwitchPressAction) {
            handleListChange(mAppSwitchPressAction, newValue,
                    LumineSettings.System.KEY_APP_SWITCH_ACTION);
            return true;
            ...
            handleListChange(mTorchLongPressPowerTimeout, newValue,
                    LumineSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT);
            return true;
            ...
            Settings.System.putInt(getContentResolver(),
                    LumineSettings.System.ENABLE_TASKBAR, ((Boolean) newValue) ? 1 : 0);
            return true;
        }
        return false;
    }
    ...
    private static void writeDisableNavkeysOption(Context context, boolean enabled) {
        Settings.System.putIntForUser(context.getContentResolver(),
                LumineSettings.System.FORCE_SHOW_NAVBAR, enabled ? 1 : 0, UserHandle.USER_CURRENT);
    }

    private void updateDisableNavkeysOption() {
        boolean enabled = Settings.System.getIntForUser(
                requireActivity().getContentResolver(),
                LumineSettings.System.FORCE_SHOW_NAVBAR, 0, UserHandle.USER_CURRENT) != 0;
    ...
    private void handleToggleHomeButtonAnswersCallPreferenceClick() {
        Settings.Secure.putInt(getContentResolver(),
                LumineSettings.Secure.RING_HOME_BUTTON_BEHAVIOR, (mHomeAnswerCall.isChecked()
                        ? LumineSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER
                        : LumineSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DO_NOTHING));
    }
