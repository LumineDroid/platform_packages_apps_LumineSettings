...
package com.android.settings.luminedroid.livedisplay;
...
import com.android.settings.luminedroid.utils.ResourceUtils;
...
import org.luminedroid.hardware.DisplayMode;
import org.luminedroid.hardware.LiveDisplayConfig;
import org.luminedroid.hardware.LiveDisplayManager;
import org.luminedroid.preference.SettingsHelper;
import org.luminedroid.providers.LumineSettings;
import com.android.settings.luminedroid.preference.CustomDialogPreference;

import static org.luminedroid.hardware.LiveDisplayManager.FEATURE_ANTI_FLICKER;
import static org.luminedroid.hardware.LiveDisplayManager.FEATURE_CABC;
import static org.luminedroid.hardware.LiveDisplayManager.FEATURE_COLOR_ADJUSTMENT;
import static org.luminedroid.hardware.LiveDisplayManager.FEATURE_COLOR_ENHANCEMENT;
import static org.luminedroid.hardware.LiveDisplayManager.FEATURE_DISPLAY_MODES;
import static org.luminedroid.hardware.LiveDisplayManager.FEATURE_PICTURE_ADJUSTMENT;
import static org.luminedroid.hardware.LiveDisplayManager.FEATURE_READING_ENHANCEMENT;
import static org.luminedroid.hardware.LiveDisplayManager.MODE_AUTO;
import static org.luminedroid.hardware.LiveDisplayManager.MODE_DAY;
import static org.luminedroid.hardware.LiveDisplayManager.MODE_NIGHT;
import static org.luminedroid.hardware.LiveDisplayManager.MODE_OFF;
import static org.luminedroid.hardware.LiveDisplayManager.MODE_OUTDOOR;
...
public class LiveDisplaySettings extends SettingsPreferenceFragment implements
    ...
    private final Uri DISPLAY_TEMPERATURE_DAY_URI =
            Settings.System.getUriFor(LumineSettings.System.DISPLAY_TEMPERATURE_DAY);
    private final Uri DISPLAY_TEMPERATURE_NIGHT_URI =
            Settings.System.getUriFor(LumineSettings.System.DISPLAY_TEMPERATURE_NIGHT);
    private final Uri DISPLAY_TEMPERATURE_MODE_URI =
            Settings.System.getUriFor(LumineSettings.System.DISPLAY_TEMPERATURE_MODE);
