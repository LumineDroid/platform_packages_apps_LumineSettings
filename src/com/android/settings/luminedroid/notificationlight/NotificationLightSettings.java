...
package com.android.settings.luminedroid.notificationlight;
...
import org.luminedroid.notification.LightsCapabilities;
import com.android.internal.logging.nano.MetricsProto.MetricsEvent;
import org.luminedroid.util.ColorUtils;

import com.android.settings.R;
import com.android.settings.luminedroid.preference.CustomDialogPreference;
import com.android.settings.search.BaseSearchIndexProvider;
import com.android.settings.luminedroid.widget.PackageListAdapter;
import com.android.settings.luminedroid.widget.PackageListAdapter.PackageItem;
...
import org.luminedroid.framework.preference.SystemSettingSwitchPreference;
import org.luminedroid.framework.preference.SystemSettingMainSwitchPreference;
...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    private static final String NOTIFICATION_LIGHT_COLOR_AUTO =
            LumineSettings.System.NOTIFICATION_LIGHT_COLOR_AUTO;
    private static final String NOTIFICATION_LIGHT_SCREEN_ON =
            LumineSettings.System.NOTIFICATION_LIGHT_SCREEN_ON;
    private static final String NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE =
            LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE;
    private static final String NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL =
            LumineSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL;
    private static final String NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN =
            LumineSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL_ZEN;
    ...
    private void refreshDefault() {
        ...
        int color = Settings.System.getInt(resolver,
                LumineSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, mDefaultColor);
        int timeOn = Settings.System.getInt(resolver,
                LumineSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, mDefaultLedOn);
        int timeOff = Settings.System.getInt(resolver,
                LumineSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, mDefaultLedOff);
        ...
        if (mCallPref != null) {
            int callColor = Settings.System.getInt(resolver,
                    LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, mDefaultColor);
            int callTimeOn = Settings.System.getInt(resolver,
                    LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, mDefaultLedOn);
            int callTimeOff = Settings.System.getInt(resolver,
                    LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, mDefaultLedOff);
        ...
        if (mVoicemailPref != null) {
            int vmailColor = Settings.System.getInt(resolver,
                    LumineSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, mDefaultColor);
            int vmailTimeOn = Settings.System.getInt(resolver,
                    LumineSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, mDefaultLedOn);
            int vmailTimeOff = Settings.System.getInt(resolver,
                    LumineSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, mDefaultLedOff);
    ...
    private boolean parsePackageList() {
        final String baseString = Settings.System.getString(
                ...
                LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES);
    ...
    private void savePackageList(boolean preferencesUpdated) {
        ...
        Settings.System.putString(getActivity().getContentResolver(),
                LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_VALUES, value);
    }
        ...
        switch (packageName) {
            case DEFAULT_PREF:
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, color);
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, timeOn);
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, timeOff);
                refreshDefault();
                return;
            case MISSED_CALL_PREF:
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, color);
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, timeOn);
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, timeOff);
                refreshDefault();
                return;
            case VOICEMAIL_PREF:
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, color);
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, timeOn);
                Settings.System.putInt(resolver,
                        LumineSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, timeOff);
                refreshDefault();
                return;
        }
