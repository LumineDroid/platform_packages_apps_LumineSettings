...
public class AboutLumineAdapter extends RecyclerView.Adapter<AboutLumineAdapter.Holder> {
    private List<About> list = new ArrayList<>();

    private OnClickListener listener;

    public AboutLumineAdapter(List<About> list, OnClickListener listener) {
        this.list = list;
    ...
    public static class TeamHeader extends About {
        public String lumineGithub;
        public String lumineTelegram;

        public TeamHeader(String gihub, String telegram) {
            lumineGithub = gihub;
            lumineTelegram = telegram;
        }
    }
    ...
    public static class Dev extends About {
        ...
        public Dev(String devName, String devRole, String devAvatarUrl, String devGithub, String devTelegram) {
    ...
    static class TeamHeaderViewHolder extends Holder {
        private ImageButton lumineGithub;
        private ImageButton lumineTelegram;

        private TeamHeader team;

        public TeamHeaderViewHolder(View itemView, final OnClickListener listener) {
            super(itemView, listener);
            lumineGithub = itemView.findViewById(R.id.lumineGithub);
            lumineTelegram = itemView.findViewById(R.id.lumineTelegram);

            lumineGithub.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.OnClick(team.lumineGithub);
                }
            });
            lumineTelegram.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.OnClick(team.lumineTelegram);
                }
            });
        }
