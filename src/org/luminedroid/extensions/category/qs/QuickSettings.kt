...
@SearchIndexable
class QuickSettings : SettingsPreferenceFragment(), Preference.OnPreferenceChangeListener, Indexable {
        ...
        val SEARCH_INDEX_DATA_PROVIDER: BaseSearchIndexProvider =
            object : BaseSearchIndexProvider(R.xml.extensions_quicksettings) {
                override fun getNonIndexableKeys(context: Context): List<String> {
                    ...
                    // The original Java code returns keys without modification,
                    // so we do the same.
                    return keys
                }
            }
