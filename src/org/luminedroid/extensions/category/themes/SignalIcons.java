...
import com.android.internal.util.luminedroid.ThemeUtils;
...
public class SignalIcons extends SettingsPreferenceFragment {
  ...
  public class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View v =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.icon_option, parent, false);
    ...
    public void onBindViewHolder(CustomViewHolder holder, final int position) {
      ...
      holder.image1.setBackgroundDrawable(
          getDrawable(holder.image1.getContext(), iconPkg, "ic_signal_cellular_0_5_bar"));
      holder.image2.setBackgroundDrawable(
          getDrawable(holder.image2.getContext(), iconPkg, "ic_signal_cellular_1_5_bar"));
      holder.image3.setBackgroundDrawable(
          getDrawable(holder.image3.getContext(), iconPkg, "ic_signal_cellular_3_5_bar"));
      holder.image4.setBackgroundDrawable(
          getDrawable(holder.image4.getContext(), iconPkg, "ic_signal_cellular_5_5_bar"));
      ...
      holder.name.setText(
          "android".equals(iconPkg) ? "Default" : getLabel(holder.name.getContext(), iconPkg));
