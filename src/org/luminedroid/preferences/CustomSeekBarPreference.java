...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
  ...
  public void onBindViewHolder(PreferenceViewHolder holder) {
    ...
    try {
      ...
      if (oldContainer != newContainer) {
        ...
        newContainer.addView(
            mSeekBar, ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
      }
    } catch (Exception ex) {
    ...
    mMinusImageView.setOnLongClickListener(
        new View.OnLongClickListener() {
          ...
          public boolean onLongClick(View view) {
            setValue(
                mMaxValue - mMinValue > mInterval * 2 && mMaxValue + mMinValue < mValue * 2
    ...
    if (mValueTextView != null) {
      if (!mTrackingTouch || mContinuousUpdates) {
        if (mDefaultValueTextExists && mDefaultValueExists && mValue == mDefaultValue) {
          ...
          mValueTextView.setText(
              getContext().getString(R.string.custom_seekbar_value, getTextValue(mValue))
        ...
        if (mDefaultValueTextExists && mDefaultValueExists && mTrackingValue == mDefaultValue) {
          ...
          mValueTextView.setText(
              getContext()
                  .getString(
                      R.string.custom_seekbar_value, "[" + getTextValue(mTrackingValue) + "]"));
        }
      }
    }
    ...
    if (mMinusImageView != null) {
      if (mValue == mMinValue || mTrackingTouch) {
        ...
        mMinusImageView.setColorFilter(
            Utils.getColorAttrDefaultColor(getContext(), android.R.attr.textColorTertiary),
  ...
  public void setDefaultValue(Object defaultValue) {
    if (defaultValue instanceof Integer) setDefaultValue((Integer) defaultValue, mSeekBar != null);
    else
      setDefaultValue(
          defaultValue == null ? (String) null : defaultValue.toString(), mSeekBar != null);
  }
